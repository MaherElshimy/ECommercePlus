        ...
        <div class="content-wrapper">
            ...
            <div class="product-form">
                <form action="{{ url('/update_product_confirm', $product->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <img src="/product/{{ $product->image }}" style="max-width: 200px; max-height: 200px;">
                    ...
                    <input type="text" name="quantity" placeholder="Enter product quantity" required value="{{ $product->quantity }}">

                    <label for="price">Product Price:</label>
                    <input type="text" name="price" phpplaceholder="Enter product price" required value="{{ $product->price }}">

                    <label for="discount_price">Discount Price:</label>
                    <input type="text" name="discount_price" placeholder="Enter discount price" value="{{ $product->discount_price }}">
